...
import (
	...
	_ "github.com/panoptisDev/tosca/go/interpreter/sfvm"    // < registers sfvm interpreter for testing
)
...
func TestGetProcessors_ContainsMainConfigurations(t *testing.T) {
	...
	wanted := []string{
		...
		"geth-pano/geth", "geth-pano/lfvm", "geth-pano/sfvm", "geth-pano/evmzero",
	}
